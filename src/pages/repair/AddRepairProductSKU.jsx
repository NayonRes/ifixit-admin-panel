...
const AddRepairProductSKU = ({ row }) => {
  ...
  const getData = async () => {
    ...
    let url = `/api/v1/repairAttachedSpareparts?repair_id=${row?._id}&status=true`;
                        ...
                        />
                          ...
                          <TableCell sx={{ minWidth: "130px" }}>
                            {row?.product?.product_data?.length > 0
                              ...
                              : "---------"}{" "}
                            &nbsp;{" "}
                            {row?.product?.spare_parts_variation_data?.length >
                            0
                              ? row?.product?.spare_parts_variation_data[0]
                                  ?.name
                              : "---------"}
                          </TableCell>
